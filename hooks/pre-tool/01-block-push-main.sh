...
echo "BLOCKED: Direct push to main/master is not allowed for code." >&2
echo "Docs/AI_RULES/plans/state may push direct to main; code must go via a PR." >&2
echo "Push code to 'test' and open a (batched) PR." >&2
exit 2
