...
#   myai brain converge                        make local main == origin/main (boot fork-killer):
#                                               ff / auto-merge / push. Auto-resolves ONLY the
#                                               regenerable distiller outputs; a real atom
#                                               conflict aborts + escalates. Zero model tokens.
